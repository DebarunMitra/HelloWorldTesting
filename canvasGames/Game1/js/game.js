    ...
    //  console.log(this.players[1]);
      ...
      //  console.log(e.keyCode);
        ...
        this.players.filter((data) =>(data.arrows.includes(e.keyCode))).map((mainItem) =>
         {
          (mainItem.arrows[0]===e.keyCode)?mainItem.x=mainItem.x-10:
          (mainItem.arrows[1]===e.keyCode)?mainItem.x=mainItem.x+10:
          (mainItem.arrows[2]===e.keyCode)?mainItem.y=mainItem.y-10:
          (mainItem.arrows[3]===e.keyCode)?mainItem.y=mainItem.y+10:
          false;
         }
       );
    }
